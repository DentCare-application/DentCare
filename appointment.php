                        ...
                        <form action="appointment.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="doctor" name="doctor" required>
                                    ...
                                    <option value="Dr. Adams">Dr. Adams - Cosmetic Dentist</option>
                                    <option value="Dr. Carter">Dr. Carter - Endodontist</option>
                                    <option value="Dr. Patel">Dr. Patel - Periodontist</option>
                                    <option value="Dr. Nguyen">Dr. Nguyen - Prosthodontist</option>
                                    <option value="Dr. Rivera">Dr. Rivera - Pediatric Dentist</option>
                                </select>
                            </div>
                            <div class="mb-3">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO appointments (full_name, email, phone, doctor, appointment_date, appointment_time, message) 
              VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    // Bind parameters
    $stmt->bind_param('sssssss', $fullName, $email, $phone, $doctor, $appointmentDate, $appointmentTime, $message);
